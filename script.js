...
function sendmsg() {
    ...
    const form = document.getElementById('contact-form'); // Code 1
...
form.addEventListener('submit', function (e) {
    ...
    // If validation passed, send AJAX request
    if (valid) {
        ...
        request.open('POST', 'backEnd\sendmsg.php', true); // replace with your server endpoint
